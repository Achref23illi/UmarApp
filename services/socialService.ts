...
export const MOCK_POSTS: Post[] = [
  {
    ...
    type: 'janaza',
    user: MOCK_USERS[0],
    content: 'Janaza Announcement: Brother Ibrahim passed away today. Prayer will be held at Central Mosque after Asr.',
    ...
    janazaData: {
      ...
      deceasedGender: 'male',
      prayerTime: 'After Asr (3:45 PM)',
      mosqueName: 'Central Mosque',
      mosqueLocation: { lat: 37.7749, lng: -122.4194 },
      cemeteryName: 'Greenwood Islamic Cemetery',
    },
  ...
  },
  {
    ...
    type: 'sick_visit',
    user: MOCK_USERS[1],
    content: 'Brother Yunus is recovering at General Hospital. Please visit him during visiting hours.',
    ...
    sickVisitData: {
      ...
      hospitalLocation: { lat: 37.7849, lng: -122.4094 },
      visitingHours: '15h - 17h',
      ward: 'Geranium, Room 501',
    },
  ...
  },
  {
    ...
    type: 'general',
    user: MOCK_USERS[0],
    content: 'Community cleanup event this coming Sunday!',
  ...
  },
  {
    ...
    type: 'janaza',
    user: MOCK_USERS[0],
    content: 'Janaza Alert: Sister Amina. Prayer tomorrow after Dhuhr.',
    ...
    janazaData: {
      ...
      prayerTime: 'After Dhuhr (1:15 PM)',
      mosqueName: 'Al-Noor Mosque',
      mosqueLocation: { lat: 37.7849, lng: -122.4094 },
    },
    location: { lat: 37.7849, lng: -122.4094 },
  },
];
